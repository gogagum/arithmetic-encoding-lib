...
////////////////////////////////////////////////////////////////////////////////
TEST(ArithmeticAEncodeDecode, EncodeEmpty) {
    const auto encoded = std::vector<std::uint64_t>();
    auto dict = ael::dict::AdaptiveADictionary(6);
...
////////////////////////////////////////////////////////////////////////////////
TEST(ArithmeticAEncodeDecode, DecodeEmpty) {
...
////////////////////////////////////////////////////////////////////////////////
TEST(ArithmeticAEncodeDecode, EncodeDecodeEmptySequence) {
    const auto encoded = std::vector<std::uint64_t>();
    auto dataConstructor = ael::ByteDataConstructor();
...
////////////////////////////////////////////////////////////////////////////////
TEST(ArithmeticAEncodeDecode, EncodeSmall) {
...
////////////////////////////////////////////////////////////////////////////////
TEST(ArithmeticAEncodeDecode, EncodeDecodeSmallSequence) {
    const auto encoded = std::vector<std::uint64_t>{5, 3, 5, 7, 2};
    auto dataConstructor = ael::ByteDataConstructor();
    auto decoded = std::vector<std::uint64_t>();
    
    {
        auto dict = ael::dict::AdaptiveADictionary(8);
...
////////////////////////////////////////////////////////////////////////////////
TEST(ArithmeticAEncodeDecode, EncodeDecodeSmallSequenceBitsLimit) {
    const auto encoded = std::vector<std::uint64_t>{5, 3, 5, 7, 2};
    auto dataConstructor = ael::ByteDataConstructor();
    auto decoded = std::vector<std::uint64_t>();
    
    auto dict0 = ael::dict::AdaptiveADictionary(8);
    const auto [wordsCount, bitsCount] =
        ael::ArithmeticCoder::encode(encoded, dataConstructor, dict0);

    {
        auto dict1 = ael::dict::AdaptiveADictionary(8);
        auto dataParser = ael::DataParser(
            std::span(dataConstructor.data<std::byte>(),
                      dataConstructor.size()));
        ael::ArithmeticDecoder::decode(
...
////////////////////////////////////////////////////////////////////////////////
TEST(ArithmeticAEncodeDecode, EncodeDecodeFuzz) {
    ...
    for (auto iteration: boost::irange(0, 50)) {
        ...
        {
            auto dict = ael::dict::AdaptiveADictionary(rng);
            const auto [wordsCount, bitsCount] =
                ael::ArithmeticCoder::encode(encoded, dataConstructor, dict);
        }
...
////////////////////////////////////////////////////////////////////////////////
TEST(ArithmeticAEncodeDecode, EncodeDecodeFuzzBitsLimit) {
    auto gen = std::mt19937(42);
    ...
    for (auto iteration: boost::irange(0, 50)) {
        ...
        auto dict1 = ael::dict::AdaptiveADictionary(rng);
        const auto [wordsCount, bitsCount] =
            ael::ArithmeticCoder::encode(encoded, dataConstructor, dict1);

        {
            auto dict2 = ael::dict::AdaptiveADictionary(rng);
            auto dataParser = ael::DataParser(
                std::span(dataConstructor.data<std::byte>(),
                          dataConstructor.size()));
            ael::ArithmeticDecoder::decode(
